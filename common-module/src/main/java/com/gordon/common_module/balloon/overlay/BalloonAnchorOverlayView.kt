...
package com.gordon.common_module.balloon.overlay
...
import com.gordon.common_module.balloon.extensions.viewProperty
...
class BalloonAnchorOverlayView @JvmOverloads constructor(
    ...
    var anchorView: View? by viewProperty(null)

    var anchorViewList: List<View>? by viewProperty(null)

    @get:ColorInt
    var overlayColor: Int by viewProperty(Color.TRANSPARENT)

    @get:ColorInt
    var overlayPaddingColor: Int by viewProperty(Color.TRANSPARENT)

    @get:Px
    var overlayPadding: Float by viewProperty(0f)

    var overlayPosition: Point? by viewProperty(null)

    var balloonOverlayShape: BalloonOverlayShape by viewProperty(BalloonOverlayOval)
